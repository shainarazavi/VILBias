...
from transformers import AutoTokenizer, MistralForSequenceClassification, AdamW, BitsAndBytesConfig
...
class MistralClassifier:
    def __init__(self, model_name="mistralai/Mistral-7B-Instruct-v0.3", num_labels=2, max_length=500):
        ...
        self.model = MistralForSequenceClassification.from_pretrained(model_name, cache_dir='/scratch/ssd004/scratch/csaleh', quantization_config=bnb_config, num_labels=num_labels)
...
if __name__ == "__main__":
    ...
    classifier = MistralClassifier(num_labels=2, max_length=1024)
