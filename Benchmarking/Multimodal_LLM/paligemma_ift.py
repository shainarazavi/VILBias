...
full_df = pd.read_csv('/fs01/projects/NMB-Plus/Caesar/Benchmarking/2sample_train.csv')

test_df = pd.read_csv('/fs01/projects/NMB-Plus/Caesar/Benchmarking/2sample_test.csv')
...
model = PaliGemmaForConditionalGeneration.from_pretrained(
    ...
    cache_dir='/scratch/ssd004/scratch/csaleh'
)
processor = AutoProcessor.from_pretrained(PALIGEMMA_MODEL_HF_ID, cache_dir='/scratch/ssd004/scratch/csaleh')
